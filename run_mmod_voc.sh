...
--result_dir="./result/`(date "+%Y%m%d%H%M%S")`-voc-320x320-mmod_res50fpn" \
\
--global_args="{
...
--tester_info_list="[{
    ...
    'tester': 'quant',
    'tester_args': {'dataset': 'voc_2007_test'}
}]" \
\
--training_args="{
...
--snapshot_iters="[20000, 40000, 55000, 70000, 85000, 100000]" \
\
# --load_dir="./result/20191219025850-voc-320x320-mmod_res34fpn/snapshot/0040000"
